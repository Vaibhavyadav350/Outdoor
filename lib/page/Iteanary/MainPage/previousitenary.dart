...
class PreviousItenary extends StatefulWidget {
  @override
  State<PreviousItenary> createState() => _PreviousItenaryState();
}
                  ...
                  child: NeoBox(
                    value: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text("Name  "+doc['groupLeadname'] ?? 'Unknown ID'),
                          Text("Pax  "+doc['pax'] ?? 'Unknown ID'),
                          Text("Vendor  "+doc['vendor'] ?? 'Unknown ID'),
                        ],
                      ),
                      onTap: () {
