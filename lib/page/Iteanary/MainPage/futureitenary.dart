...
class _FutureItenaryState extends State<FutureItenary> {
  ...
  String OnGoing = "FutureItenary Itenary";
  ...
  Future<void> fetchComapnyname() async {
    ...
    _collections = collections.map((collection) => collection['collectionId'] as String).toList();
    setState(() {
  ...
  Future<List<Map<String, dynamic>>> getCollections(String fieldName) async {
    ...
    for (var collection in querySnapshot.docs) {
      ...
      Map<String, dynamic>? collectionData = collection.data() as Map<String, dynamic>?;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _collections.isEmpty ? Center(
            ...
            if (collections.isEmpty) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  String collection = collections[index]['name'] as String;
                  String documentId = collections[index]['collectionId'] as String;
                  return Padding(
